...
const domStuff = (function() {
  ...
  const newTaskForm = document.querySelector("#new-task").addEventListener("submit", e => {
    ...
    const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.default)(new Date(dueDate), "dd/MM/yyyy")
...
const app = (function() {
  ...
  const sortByWeek = () => {
    ...
    const week = dataBase.taskData.filter(item => item.dueDate === (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(item.dueDate), {weekStartsOn: 1} )
